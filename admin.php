<?php
  ...
  if(isset($_SESSION['user']) == false or $isAdmin==0){
...
<body onload="loadedPlace('getAPlaces')" >
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown-7">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown mx-2">
                        <a class="nav-link activeNav text-info" href="#">Admin</a>
                    </li>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-white">
                            <div class="card-body">
                                ...
                                <input type="text" id="searchPlace" onkeyup="searchPlaceByName()" class="form-control" placeholder="Név">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card bg-white">
                            <div class="card-body">
                                <h5 class="card-title">Új helyszín hozzáadása</h5>
                                <button class="btn btn-info" onclick="newPlace()">Tovább</button>
                            </div>
                        </div>
                    </div> 
                    <div class="container">
            ...
            <div class="section">
                <div class="row">
                    <div class="col-12 col-md-8 offset-md-2 text-center" style="margin-top:20px">
                        ...
                        <h3 class="text-info">Kategóriák</h3>                 
                    </div>
                    <div class="col-md-12">
                        <div class="card bg-white">
                            <div class="card-body">
                                <h5 class="card-title">Új kategória hozzáadása</h5>
                                <button class="btn btn-info" onclick="newPlace()">Tovább</button>
                            </div>
                        </div>
                    </div> 
        ...
        <div class="container">
            <div class="section">
                <div class="row">
                    <div class="col-12 col-md-8 offset-md-2 text-center" style="margin-top:20px">
                        <i class="fas fa-users-cog fa-4x text-info"></i>
                        <h3 class="text-info">Jelentkezők</h3>                 
                    </div>
                    <div class="col-md-12">
                        <div class="card bg-white">
                            <div class="card-body">
                                <h5 class="card-title">Keresés név szerint</h5>
                                <input type="text" id="searchname" onkeyup="searchPersonByName()" class="form-control" name="searchName" placeholder="Név">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="section">
                            <div class="userCards" id="asd" style="width:100%;margin-bottom:20px;margin-top:20px"></div>
                        </div>    
                    </div>                   
                </div>                
            </div>      
